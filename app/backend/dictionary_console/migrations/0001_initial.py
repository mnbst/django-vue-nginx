    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_genre', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=50), size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appearance', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(default=0), size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('words', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=20, null=True), size=None)),
                ('meanings', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=20, null=True), size=None)),
                ('video_href', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dictionary_console.Video', to_field='video_href')),
            ],
        ),
    ]
